...
class Agent:
    ...
    def train_agent(self):
        ...
        self.critic_target_update(self.critic.model1, self.critic_target.model1, tau = 0.005, soft_update = True)
        self.critic_target_update(self.critic.model2, self.critic_target.model2, tau = 0.005, soft_update = True)
